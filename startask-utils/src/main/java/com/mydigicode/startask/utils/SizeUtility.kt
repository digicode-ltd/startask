...
fun Context.dip(value: Int): Int = (value * SizeUtility.getDensity()).toInt()
fun Context.dip(value: Float): Int = (value * SizeUtility.getDensity()).toInt()
fun Context.sp(value: Int): Int = (value * SizeUtility.getScaledDensity()).toInt()
fun Context.sp(value: Float): Int = (value * SizeUtility.getScaledDensity()).toInt()
fun Context.px2dip(px: Int): Float = px.toFloat() / SizeUtility.getDensity()
fun Context.px2sp(px: Int): Float = px.toFloat() / SizeUtility.getScaledDensity()
